...
*    FileUpload
*
*    A PHP class to upload files with php 5 or higher,please feel free to use it.
*
*    @author djstava <djstava@gmail.com>
*    @author http://www.xugaoxiang.com/
*/
...
class FileUpload
{
    ...
    */
    public function __construct($destination)
    {
        ...
        if (!$this->setDestinationDirectory($destination)) {
            $this->log('set destination dir error.<br />');
        }
    ...
    */
    protected function setDestinationDirectory($destination_directory) {
        ...
        if ($this->isDirpath($destination_directory)) {
            if ($this->dirExists($destination_directory)) {
                ...
                if(mkdir($destination_directory,0777)) {
                    if ($this->dirExists($destination_directory)) {
                        $this->destination_directory = $destination_directory;
                        if (substr($this->destination_directory, -1) != DIRECTORY_SEPARATOR) {
                            $this->destination_directory .= DIRECTORY_SEPARATOR;
